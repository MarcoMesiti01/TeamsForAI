...
function buildBoardOperationSchema() {
  const createNodeSchema = {
    ...
    properties: {
      ...
      emphasis: { type: "string", enum: ["normal", "primary", "secondary", "muted"] },
      workspace_entry_id: { type: ["string", "null"] },
      memory_status: { type: ["string", "null"], enum: ["committed", "exploratory", null] },
  ...
  const updateNodeSchema = {
    ...
    required: ["type", "id", "text", "group_id", "workspace_entry_id", "memory_status", "origin"],
    additionalProperties: false,
  };
  const createEdgeSchema = {
    type: "object",
    properties: {
      type: { type: "string", enum: ["create_edge"] },
      id: { type: "string" },
      from: { type: "string" },
      to: { type: "string" },
      label: { type: "string" },
    },
    required: ["type", "id", "from", "to", "label"],
    additionalProperties: false,
  };
  const createGroupSchema = {
    ...
    required: ["type", "id", "title", "node_ids"],
    additionalProperties: false,
  };
  const moveItemSchema = {
    type: "object",
    properties: {
      type: { type: "string", enum: ["move_item"] },
      id: { type: "string" },
      x: { type: "number" },
      y: { type: "number" },
    },
  ...
  const emphasizeItemSchema = {
    type: "object",
    properties: {
      type: { type: "string", enum: ["emphasize_item"] },
      id: { type: "string" },
      emphasis: { type: "string", enum: ["normal", "primary", "secondary", "muted"] },
    },
    required: ["type", "id", "emphasis"],
    additionalProperties: false,
  };
  const deleteItemSchema = {
    type: "object",
    properties: {
      type: { type: "string", enum: ["delete_item"] },
      id: { type: "string" },
    },
    required: ["type", "id"],
    additionalProperties: false,
        ...
        format: {
          ...
          schema: {
            ...
            properties: {
              ...
              board_operations: {
                type: "array",
                items: buildBoardOperationSchema(),
              },
