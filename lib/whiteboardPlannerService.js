...
function buildWhiteboardPlanInput(intent = {}, board, options = {}) {
  ...
  return {
    ...
    workspace_context: intent.workspace_context && typeof intent.workspace_context === "object" ? clone(intent.workspace_context) : null,
...
async function callWhiteboardPlannerModel(planInput, options = {}) {
  if (options.plannerProvider) {
    return normalizePlannerOutput(await options.plannerProvider(clone(planInput)));
  }
